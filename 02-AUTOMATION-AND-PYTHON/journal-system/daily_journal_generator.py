...
START_DATE = "2026-02-05"  # Votre J1 réel
REPO_PATH = os.path.expanduser("~/votre-repo-100Days")  # Adapter chemin
...
def generate_daily_journal(day_number):
    ...
    month_folder = f"{REPO_PATH}/JOURNAL-DE-BORD/2026-{current_date.strftime('%m')}-{month_name}/"
